...
Yocto requires the environment to be configured before building is possible.  A setup-environment script in the sc589-ezkit folder contains all the required environment settings for your build target.
...
.. code-block:: shell
   ...
   ls tmp/deploy/sdk
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-ezkit-toolchain-3.1.1.host.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-ezkit-toolchain-3.1.1.sh
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-ezkit-toolchain-3.1.1.target.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-ezkit-toolchain-3.1.1.testdata.json


The ``adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-ezkit-toolchain-3.1.1.sh`` is a self-extracting archive containing the SDK.
...
.. code-block:: shell
   ...
   ./adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa55-adsp-sc589-ezkit-toolchain-3.1.1.sh
...
<img src="https://github.com/analogdevicesinc/lnxdsp-adi-meta/assets/110021710/96de8689-92a7-4440-9a67-2fb245c09fab" width="400">
...
<img src="https://github.com/analogdevicesinc/lnxdsp-adi-meta/assets/110021710/2522110a-a46f-47ed-82df-683f806aba5f" width="400">
...
.. code-block:: shell
   ...
   cd /tftpboot
   /opt/adi-distro-glibc/3.1.1/sysroots/x86_64-adi_glibc_sdk-linux/usr/bin/arm-adi_glibc-linux-gnueabi/arm-adi_glibc-linux-gnueabi-gdb u-boot-spl-sc589-ezkit.elf
   ...
...
.. code-block:: shell
   ...
   sudo mkdir /mnt/boot
   sudo cp tmp/deploy/images/adsp-sc589-ezkit/adsp-sc5xx-ramdisk-adsp-sc589-ezkit.cpio.xz /mnt/boot/adsp-sc5xx-ramdisk-adsp-sc589-ezkit.cpio.xz.u-boot
...
The ADSP-SC589 EZ-KIT comes equipped with 16 MiB of SPI Flash. There's the option of building the ``adsp-sc5xx-tiny image``, after changing the Libc implementation from the default GNU to musl, to further reduce the image's size. Follow the guide in `Boot from SPI Flash on the SC58x & SC573 <../boot/Booting-Linux-from-SPI-Flash-on-SC58x-&-SC573>`