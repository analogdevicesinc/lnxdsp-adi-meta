...
-----------------------
Yocto requires the environment to be configured before building is possible.  A setup-environment script in the adsp-sc589-mini-yocto-build folder contains all the required environment settings for your build target.
...
.. code-block:: shell
   ...
   ls tmp/deploy/sdk
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-mini-toolchain-5.0.1.host.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-mini-toolchain-5.0.1.sh
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-mini-toolchain-5.0.1.target.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-mini-toolchain-5.0.1.testdata.json

The ``adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc589-mini-toolchain-5.0.1.sh`` is a self-extracting archive containing the SDK.
...
.. code-block:: shell
   ...
   ./adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa55-adsp-sc589-mini-toolchain-5.0.1.sh
...
.. code-block:: shell
   ...
   cd /tftpboot
   /opt/adi-distro-glibc/5.0.1/sysroots/x86_64-adi_glibc_sdk-linux/usr/bin/arm-adi_glibc-linux-gnueabi/arm-adi_glibc-linux-gnueabi-gdb u-boot-spl-sc589-mini.elf
   ...
...
.. code-block:: shell
   ...
   cp tmp/deploy/images/adsp-sc589-mini/adsp-sc5xx-minimal-adsp-sc589-mini.rootfs.jffs2 /tftpboot
...
.. code-block:: shell
   ...
   Using eth0 device
   TFTP from server 192.168.1.116; our IP address is 192.168.1.113
   Filename 'adsp-sc5xx-minimal-adsp-sc589-mini.rootfs.jffs2'.
   Load address: 0x82000000
   Loading: #################################################################
            #################################################################
            #################################################################
...
.. code-block:: shell
   ...
   sudo mkdir /mnt/boot
   sudo cp tmp/deploy/images/adsp-sc589-mini/adsp-sc5xx-ramdisk-adsp-sc589-mini.rootfs.cpio.xz /mnt/boot/adsp-sc5xx-ramdisk-adsp-sc589-mini.cpio.xz.u-boot
   ...
   sudo tar -xf tmp/deploy/images/adsp-sc589-mini/adsp-sc5xx-minimal-adsp-sc589-mini.rootfs.tar.xz -C /mnt
   sudo umount /mnt
