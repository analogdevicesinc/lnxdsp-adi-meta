...
The default configuration is valid for SOM Rev A/B/C/D with an EZkit Carrier rev D. `Guide to identify SOM and EZKit Carrier revision numbers <Identifying-ADSP‐SC594-and-ADSP‐SC598-SOM-and-Carrier-board-revisions.html>`_
...
.. code-block:: shell
   ...
   ls tmp/deploy/sdk
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-full-cortexa55-adsp-sc598-som-ezkit-toolchain-5.0.1.host.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-full-cortexa55-adsp-sc598-som-ezkit-toolchain-5.0.1-host.spdx.tar.zst
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-full-cortexa55-adsp-sc598-som-ezkit-toolchain-5.0.1.sh
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-full-cortexa55-adsp-sc598-som-ezkit-toolchain-5.0.1.target.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-full-cortexa55-adsp-sc598-som-ezkit-toolchain-5.0.1-target.spdx.tar.zst
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-full-cortexa55-adsp-sc598-som-ezkit-toolchain-5.0.1.testdata.json

The ``adi-distro-glibc-glibc-x86_64-adsp-sc5xx-full-cortexa55-adsp-sc598-som-ezkit-toolchain-5.0.1.sh`` is a self-extracting archive containing the SDK.
...
.. code-block:: shell
   ...
   ./adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa55-adsp-sc598-som-ezkit-toolchain-5.0.1.sh
...
.. code-block:: shell
   ...
   cd /tftpboot
   /opt/adi-distro-glibc/5.0.1/sysroots/x86_64-adi_glibc_sdk-linux/usr/bin/aarch64-adi_glibc-linux/aarch64-adi_glibc-linux-gdb u-boot-spl-sc598-som-ezkit.elf
   ...
...
.. code-block:: shell
   ...
   Welcome to Analog Devices Inc Reference Distro (glibc) 5.0.1 (scarthgap)!
