...
Yocto requires the environment to be configured before building is possible.  A setup-environment script in the sc584-ezkit folder contains all the required environment settings for your build target.
...
.. code-block:: shell
   ...
   ls tmp/deploy/sdk
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc584-ezkit-toolchain-3.1.1.host.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc584-ezkit-toolchain-3.1.1.sh
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc584-ezkit-toolchain-3.1.1.target.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc584-ezkit-toolchain-3.1.1.testdata.json


The ``adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc584-ezkit-toolchain-3.1.1.sh`` is a self-extracting archive containing the SDK.
...
.. code-block:: shell
   ...
   ./adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa55-adsp-sc584-ezkit-toolchain-3.1.1.sh
...
<img src="https://github.com/analogdevicesinc/lnxdsp-adi-meta/assets/110021710/24c4c2b2-4fb3-4711-8cc1-f4db257874e8" width="400">
...
<img src="https://github.com/analogdevicesinc/lnxdsp-adi-meta/assets/110021710/0320f1ac-0b3b-42ab-8d67-e695ba290b5d" width="400">
...
.. code-block:: shell
   ...
   cd /tftpboot
   /opt/adi-distro-glibc/3.1.1/sysroots/x86_64-adi_glibc_sdk-linux/usr/bin/arm-adi_glibc-linux-gnueabi/arm-adi_glibc-linux-gnueabi-gdb u-boot-spl-sc584-ezkit.elf
   ...
