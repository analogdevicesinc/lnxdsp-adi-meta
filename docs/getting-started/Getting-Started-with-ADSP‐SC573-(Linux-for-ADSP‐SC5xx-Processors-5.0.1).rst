...
.. code-block:: shell
   ...
   mkdir ~/adsp-sc573-yocto-build
   cd ~/adsp-sc573-yocto-build
   mkdir bin
...
-----------------------
Yocto requires the environment to be configured before building is possible.  A setup-environment script in the adsp-sc573-yocto-build folder contains all the required environment settings for your build target.
...
.. code-block:: shell
   ...
   ls tmp/deploy/sdk
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc573-ezkit-toolchain-5.0.1.host.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc573-ezkit-toolchain-5.0.1-host.spdx.tar.zst
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc573-ezkit-toolchain-5.0.1.sh
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc573-ezkit-toolchain-5.0.1.target.manifest
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc573-ezkit-toolchain-5.0.1-target.spdx.tar.zst
   adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc573-ezkit-toolchain-5.0.1.testdata.json

The ``adi-distro-glibc-glibc-x86_64-adsp-sc5xx-minimal-cortexa5t2hf-neon-adsp-sc573-ezkit-toolchain-5.0.1.sh`` is a self-extracting archive containing the SDK.
...
.. code-block:: shell
   ...
   Info : JTAG tap: adspsc57x.adjc tap/device found: 0x0282e0cb (mfg: 0x065 (Analog Devices), part: 0x282e, ver: 0x0)
   Info : JTAG tap: adspsc57x.cpu enabled
   Info : DAP adspsc57x.cpu DPIDR indicates ADIv6 protocol is being used
   Info : adspsc57x.cpu: hardware has 6 breakpoints, 4 watchpoints
   Info : starting gdb server for adspsc57x.cpu on 3333
...
.. code-block:: shell
   ...
   cd /tftpboot
   /opt/adi-distro-glibc/5.0.1/sysroots/x86_64-adi_glibc_sdk-linux/usr/bin/arm-adi_glibc-linux-gnueabi/arm-adi_glibc-linux-gnueabi-gdb u-boot-spl-sc573-ezkit.elf
   ...
...
.. code-block:: shell
   ...
   CPU:   ADSP ADSP-SC573-0.0 (spi slave boot)
...
.. code-block:: shell
   ...
   sudo tar -xf tmp/deploy/images/adsp-sc573-ezkit/adsp-sc5xx-full-adsp-sc573-ezkit.rootfs.tar.xz -C /romfs
...
.. code-block:: shell
   ...
   sudo mkdir /mnt/boot
   sudo cp tmp/deploy/images/adsp-sc573-ezkit/adsp-sc5xx-ramdisk-adsp-sc573-ezkit.rootfs.cpio.xz /mnt/boot/adsp-sc5xx-ramdisk-adsp-sc573-ezkit.cpio.xz.u-boot
   ...
   sudo tar -xf tmp/deploy/images/adsp-sc573-ezkit/adsp-sc5xx-minimal-adsp-sc573-ezkit.rootfs.tar.xz -C /mnt
   sudo umount /mnt
