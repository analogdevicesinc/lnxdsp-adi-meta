...
**Note:** install :adi:`CCES (CrossCore Embedded Studio) <en/design-center/evaluation-hardware-and-software/software/adswt-cces.html#software-relatedsoftware>`
...
to boot and you need to re-follow these instructions.
